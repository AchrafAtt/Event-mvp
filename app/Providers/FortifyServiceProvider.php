...
use App\Http\Controllers\Auth\EmailVerificationPromptController as AppEmailVerificationPromptController;
...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->bind(
            FortifyEmailVerificationPromptController::class,
            AppEmailVerificationPromptController::class,
        );
        $this->app->bind(
            FortifyEmailVerificationNotificationController::class,
