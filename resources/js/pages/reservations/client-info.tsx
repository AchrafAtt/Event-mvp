            ...
            <div className="bg-bg-global text-text-primary min-h-screen">
                <header className="border-border/70 bg-white/90 sticky top-0 z-40 border-b backdrop-blur-md">
                    <div className="mx-auto flex h-[68px] w-full max-w-6xl items-center justify-between px-4 md:px-8">
                        ...
                        <Link href={home()} className="font-['Cormorant_Garamond'] text-3xl leading-none font-medium">
                            Ghozel Events
                        </Link>
                ...
                <main className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-8 px-4 pt-10 pb-16 md:grid-cols-[1fr_360px] md:px-8">
                    <section>
                        ...
                        <h1 className="font-['Cormorant_Garamond'] text-4xl leading-tight font-light md:text-6xl">
                            Vos <em className="text-primary font-normal italic">informations</em>
                        </h1>
                        <p className="text-text-secondary mt-3 mb-10 max-w-3xl text-sm leading-7 md:text-base">
                            Renseignez vos coordonnees pour que nous puissions preparer votre evenement.
                        </p>
                        ...
                        <form onSubmit={submit} className="grid grid-cols-1 gap-5 md:grid-cols-2">
                            <div className="md:col-span-2">
                                ...
                                <input
                                    ...
                                    className={`w-full rounded-xl border bg-white px-4 py-3 outline-none transition-all ${
                                        errors.nom ? 'border-error' : 'border-border focus:border-primary'
                                    }`}
                                    placeholder="Sara Benali"
                                />
                                {errors.nom && <p className="text-error mt-2 text-xs">{errors.nom}</p>}
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full rounded-xl border bg-white px-4 py-3 outline-none transition-all ${
                                        errors.telephone ? 'border-error' : 'border-border focus:border-primary'
                                    }`}
                                    placeholder="06 12 34 56 78"
                                />
                                {errors.telephone && <p className="text-error mt-2 text-xs">{errors.telephone}</p>}
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value={form.email}
                                    readOnly
                                    className="border-border text-text-secondary w-full cursor-not-allowed rounded-xl border bg-white/80 px-4 py-3"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className={`w-full rounded-xl border bg-white px-4 py-3 outline-none transition-all ${
                                        errors.zone ? 'border-error' : 'border-border focus:border-primary'
                                    }`}
                                >
                                ...
                                {errors.zone && <p className="text-error mt-2 text-xs">{errors.zone}</p>}
                            </div>
                            ...
                            <div className="md:col-span-2">
                                ...
                                <input
                                    ...
                                    onChange={(event) =>
                                        setForm((current) => ({ ...current, adresse_detaillee: event.target.value }))
                                    }
                                    className={`w-full rounded-xl border bg-white px-4 py-3 outline-none transition-all ${
                                        errors.adresse_detaillee ? 'border-error' : 'border-border focus:border-primary'
                                    }`}
                                    placeholder="Villa 12, Lotissement Al Kawtar"
                                />
                                {errors.adresse_detaillee && <p className="text-error mt-2 text-xs">{errors.adresse_detaillee}</p>}
                            </div>
                    ...
                    <aside className="md:sticky md:top-24">
                        <div className="border-border rounded-2xl border bg-white p-6 shadow-sm">
                            ...
                            <div className="bg-accent/20 mt-4 rounded-xl p-4 text-xs leading-6">
                                <strong>Bon a savoir :</strong> une avance de <strong>200 DH</strong> est requise pour
